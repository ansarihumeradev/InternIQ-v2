                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center space-x-1.5">
                        ...
                        <span>Attached Profile Resume / Upload Resume <span className="text-rose-500">*</span></span>
                      </label>
                      {resumeDataUrl && (
                    ...
                    {resumeDataUrl ? (
                      ...
                      <div className="bg-emerald-50/70 border border-emerald-200 rounded-xl p-3.5 flex items-center justify-between transition-all">
                        <div className="flex items-center space-x-3 overflow-hidden">
                          <div className="w-9 h-9 rounded-lg bg-emerald-100 flex items-center justify-center flex-shrink-0 text-emerald-700">
                            <FileText className="w-5 h-5" />
                          </div>
                          <div className="truncate">
                            <p className="text-xs font-bold text-slate-800 truncate">{resumeFileName || 'Resume.pdf'}</p>
                        ...
                        <div className="flex items-center space-x-2 flex-shrink-0">
                          <button
                            ...
                            className="px-2.5 py-1 bg-white border border-emerald-300 text-emerald-700 rounded-lg text-[11px] font-semibold hover:bg-emerald-50 transition-colors flex items-center space-x-1"
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 bg-indigo-600 text-white rounded-lg text-[11px] font-semibold hover:bg-indigo-700 transition-colors flex items-center space-x-1"
                      ...
                      <div
                        onClick={() => resumeInputRef.current?.click()}
                        className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all hover:bg-indigo-50/50 hover:border-indigo-400 ${
                          resumeError ? 'border-rose-300 bg-rose-50/60' : 'border-slate-200 bg-slate-50/70'
                        }`}
                    ...
                    {resumeError ? (
                      <p className="text-rose-500 text-[11px] flex items-center space-x-1 font-semibold pt-0.5">
                ...
                <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 bg-indigo-600 text-white font-bold text-xs rounded-xl hover:bg-indigo-700 shadow-md shadow-indigo-200 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
