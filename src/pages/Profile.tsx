          ...
          <div className="flex items-center space-x-3">
            {isEditing ? (
              <button
                ...
                disabled={loading}
                className="px-5 py-2.5 bg-indigo-600 text-white font-semibold text-xs rounded-xl shadow-md hover:bg-indigo-700 transition-all flex items-center space-x-1.5 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 bg-slate-100 text-slate-700 font-semibold text-xs rounded-xl border border-slate-200 hover:bg-slate-200 transition-all flex items-center space-x-1.5 cursor-pointer"
              >
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 space-y-4">
                <h3 className="font-bold text-slate-800 text-sm flex items-center">
                  <Building className="w-4 h-4 mr-2 text-indigo-600" /> Company Identity
                </h3>

                <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200 rounded-xl bg-slate-50/50 text-center space-y-3">
                  {formData.avatar ? (
                    <img
                      src={formData.avatar}
                      alt="Company Logo"
                    ...
                    <div className="w-24 h-24 bg-gradient-to-tr from-slate-800 to-indigo-900 text-white font-black text-3xl rounded-2xl flex items-center justify-center shadow-md">
                  ...
                  <label className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs rounded-xl shadow cursor-pointer transition-all flex items-center space-x-1.5">
                    <Upload className="w-3.5 h-3.5" />
                ...
                <div className="pt-2 text-xs text-slate-500 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-indigo-600">Company Recruiter</span>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 space-y-5">
                <div className="border-b border-slate-100 pb-3">
                  <h3 className="font-extrabold text-slate-900 text-base flex items-center">
                    <Briefcase className="w-5 h-5 mr-2 text-indigo-600" /> Company & Recruiter Details
                  </h3>
                ...
                <div className="space-y-4 text-xs">
                  <div>
                    <label className="text-slate-500 block font-semibold mb-1">Company Name</label>
                    {isEditing ? (
                      <input
                        type="text"
                        value={formData.name}
                        ...
                        className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 text-slate-800 text-xs"
                      />
                    ) : (
                      <p className="font-bold text-slate-800 text-sm">{formData.name || <span className="text-slate-400 italic font-normal text-xs">Not provided</span>}</p>
                    )}
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Company Website</label>
                      {isEditing ? (
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Position / Title at Company</label>
                      {isEditing ? (
                        <input
                          type="text"
                        ...
                        <p className="font-semibold text-slate-800">{formData.experience || <span className="text-slate-400 italic font-normal">Not provided</span>}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Contact Email</label>
                      {isEditing ? (
                        <input
                          type="email"
                          ...
                          className="w-full p-2.5 bg-slate-100 border border-slate-200 rounded-xl text-slate-500 cursor-not-allowed text-xs"
                        />
                      ) : (
                    ...
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Contact Phone</label>
                      {isEditing ? (
                        <input
                          type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Headquarters / Location</label>
                      {isEditing ? (
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-slate-500 block font-semibold mb-1">Company LinkedIn</label>
                      {isEditing ? (
                        <input
                          type="text"
                  ...
                  <div>
                    <label className="text-slate-500 block font-semibold mb-1">Company Description / About</label>
                    {isEditing ? (
                      <textarea
                        rows={4}
                        ...
                        className="w-full p-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 text-slate-800 resize-none text-xs"
                      />
                    ) : (
                      <p className="text-slate-700 leading-relaxed">{formData.summary || <span className="text-slate-400 italic font-normal">No company description provided yet.</span>}</p>
                    )}
                  </div>
                </div>
              </div>
