          ...
          <div className="w-full max-w-[420px] mx-auto">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-6 bg-white hover:bg-slate-50 active:bg-slate-100 border border-slate-200 hover:border-slate-300 rounded-xl text-sm font-semibold text-slate-700 transition-all shadow-sm hover:shadow disabled:opacity-50 cursor-pointer"
              >
                {oauthLoading === 'google' ? (
