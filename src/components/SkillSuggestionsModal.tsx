      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto space-y-4">
            <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 text-xs text-indigo-800 flex items-start space-x-2">
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-xl border transition-all ${
                        isChecked ? 'bg-indigo-50/40 border-indigo-200' : 'bg-slate-50 border-slate-200 opacity-60'
                      }`}
                    >
          ...
          <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
            ...
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium text-sm rounded-xl hover:shadow-lg hover:shadow-indigo-200 transition-all flex items-center space-x-2 disabled:opacity-50"
            >
